...
Page({
    ...
    onLoad: function(a) {
        app.pageOnLoad(this), wx.removeStorageSync("input_data");
    ...
    getOrderData: function(a) {
        var s = this, t = "";
        s.data.address && s.data.address.id && (t = s.data.address.id), a.goods_info && (wx.showLoading({
            title: "正在加载",
            mask: !0
        }), app.request({
            ...
            success: function(a) {
                if (wx.hideLoading(), 0 == a.code) {
                    if (2 == s.data.offline) var t = parseFloat(0 < a.data.total_price - a.data.colonel ? a.data.total_price - a.data.colonel : .01), e = 0; else t = parseFloat(0 < a.data.total_price - a.data.colonel ? a.data.total_price - a.data.colonel : .01) + a.data.express_price, 
