...
Page({
    ...
    onReady: function() {},
    onShow: function(t) {
        if (!getApp().onShowData || !getApp().onShowData.scene || 1034 != getApp().onShowData.scene) if (loadingImg) loadingImg = !1; else {
            getCurrentPages();
            app.pageOnShow(this);
    ...
    getOrderData: function(t) {
        ...
        t.goods_info && (a.goods_info = t.goods_info), app.request({
