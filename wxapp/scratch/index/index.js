...
Page({
    ...
    init: function() {
        ...
        s.setData({
            ...
            i.drawImage("/scratch/images/scratch_hide_2.png", 0, 0, a, e), i.draw(!1, function(t) {
                s.setData({
                    award_name: !0
                });
            }), s.setData({
    ...
    clearArc: function(t, a, e) {
        var i = this.data.r, s = this.data.ctx, o = i - e, r = Math.sqrt(i * i - o * o), n = t - o, c = a - r, d = 2 * o, h = 2 * r;
